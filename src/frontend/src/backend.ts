...
export class Backend implements backendInterface {
    ...
    async addWish(arg0: string, arg1: string): Promise<void> {
    ...
    async clearWishes(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.clearWishes();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllWishes(): Promise<Array<Wish>> {
        if (this.processError) {
            try {
    ...
    async getBirthdayProfile(): Promise<BirthdayProfile> {
        if (this.processError) {
            try {
                const result = await this.actor.getBirthdayProfile();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setBirthdayProfile(arg0: BirthdayProfile): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setBirthdayProfile(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
